...
# --- Configuration ---
CLIENT_CODE_DIR="/home/dhruv/winshare/Code/mosquitto/client_code"
COMMON_DIR="/home/dhruv/winshare/Code/mosquitto/common"
INCLUDE_DIR="/home/dhruv/winshare/Code/mosquitto/include"
LIB_DIR="/home/dhruv/winshare/Code/mosquitto/lib"
...
echo "🔧 Compiling subscribers (subscriber_B6_neg)..."
    FILE="subscriber_B6_neg"
    SRC="$CLIENT_CODE_DIR/${FILE}.c"
    OUT="$BIN_DIR/${FILE}"
    if [ -f "$SRC" ]; then
        echo "   -> Compiling ${FILE}.c"
